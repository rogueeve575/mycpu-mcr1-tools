...
#define LOCALQUOTE			'\"'
// makegen skips over source lines with line comments matching this string. this lets you
// tell it that dependencies to certain files don't count, even if they appear
// to exist. (also a workaround when it bugs)
#define IGNORESTR			" MG:IGNORE"
