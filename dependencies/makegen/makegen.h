...
typedef struct
{
	char name[MAXFNAMELEN];			// source file name
	char modulename[MAXFNAMELEN];	// filename without extension
	char ext[MAXFNAMELEN];			// the file extension
	...
	struct
	{
		...
		char *prototype;			// function's prototype
